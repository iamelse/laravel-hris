...
<main>
    <div class="p-4 mx-auto max-w-screen-2xl md:p-6">
        <!-- Page Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Apply for Leave</h1>
            <p class="text-gray-600 dark:text-gray-400">Fill out the form below to request a leave.</p>
        </div>

        <!-- Leave Application Form -->
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <form action="{{ route('employee.leave.store') }}" method="POST" class="space-y-6">
                @csrf

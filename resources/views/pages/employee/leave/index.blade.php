   ...
   <div class="p-4 mx-auto max-w-screen-2xl md:p-6">
    ...
    <div class="px-6 py-4">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            >
                <i class="bx bx-plus mr-2 text-lg"></i> Apply for Leave
            </a>
        </div>
    </div>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex flex-col space-y-1">
                                        ...
                                        @if ($application->status === 'pending')
                                            <span class="text-yellow-500 text-xs italic">Waiting Response</span>
                                        ...
                                        @else
                                            <span class="text-xs text-gray-400 italic">No approver</span>
                                        @endif
                                    </div>
                                </td>
